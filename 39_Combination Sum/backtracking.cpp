...
void combination(vector<int>& arr, int target, vector<int>& currComb, int currSum, int currIndex, vector<vector<int>>& ans){
...
int main(){
    ...
    solve(0,candidates, temp, target); // calling function, and see we start from index zero
